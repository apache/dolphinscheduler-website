    ...
    sidemenu: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: 'Architecture Design',
            link: '/en-us/docs/1.3.3/user_doc/architecture-design.html',
          },
          {
            title: 'Configuration File',
            link: '/en-us/docs/1.3.3/user_doc/configuration-file.html',
          },
          {
            title: 'Task Structure',
            link: '/en-us/docs/1.3.3/user_doc/task-structure.html',
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            link: '/en-us/docs/1.3.3/user_doc/expansion-reduction.html',
          },
        ],
      },
      {
    ...
    sidemenu: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: '配置文件',
            link: '/zh-cn/docs/1.3.3/user_doc/configuration-file.html',
          },
          {
            title: '任务结构',
            link: '/zh-cn/docs/1.3.3/user_doc/task-structure.html',
          },
        ],
      },
      {
