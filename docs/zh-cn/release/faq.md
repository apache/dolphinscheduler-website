...
## Q：如何增加一台工作服务器
A： 1，参考官网[部署文档](https://dolphinscheduler.apache.org/zh-cn/docs/1.3.4/user_doc/cluster-deployment.html) 1.3 小节，创建部署用户和 hosts 映射

​	2，参考官网[部署文档](https://dolphinscheduler.apache.org/zh-cn/docs/1.3.4/user_doc/cluster-deployment.html) 1.4 小节，配置 hosts 映射和 ssh 打通及修改目录权限.
...
```   
 ...
 ``` 
   3，如果步骤 2 报错，请重新构建 node-saas [参考链接](https://dolphinscheduler.apache.org/zh-cn/docs/1.3.4/user_doc/frontend-development.html)
```
