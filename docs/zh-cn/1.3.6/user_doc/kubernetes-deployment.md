...
配置文件为 `values.yaml`，[DolphinScheduler Kubernetes 配置](https://github.com/apache/dolphinscheduler/blob/1.3.6/docker/kubernetes/dolphinscheduler/README.md#configuration) 列出了 DolphinScheduler 的可配置参数及其默认值
