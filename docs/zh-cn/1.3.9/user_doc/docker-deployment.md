...
请下载二进制包 apache-dolphinscheduler-1.3.9-bin.tar.gz，下载地址: [下载](/zh-cn/download/download.html). 然后将 apache-dolphinscheduler-1.3.9-bin.tar.gz 放到 `apache-dolphinscheduler-1.3.9-src/docker/build` 目录里，在 Terminal 或 PowerShell 中执行:
