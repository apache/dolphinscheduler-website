...
请下载源码包 apache-dolphinscheduler-2.0.0-src.tar.gz，下载地址: [下载](https://dolphinscheduler.apache.org/zh-cn/download/download.html)
...
请下载二进制包 apache-dolphinscheduler-2.0.0-bin.tar.gz，下载地址: [下载](https://dolphinscheduler.apache.org/zh-cn/download/download.html). 然后将 apache-dolphinscheduler-2.0.0-bin.tar.gz 放到 `apache-dolphinscheduler-2.0.0-src/docker/build` 目录里，在 Terminal 或 PowerShell 中执行:
