...
单机部署请参照[单机部署(Standalone)](/zh-cn/docs/2.0.0/user_doc/guide/installation/standalone.html)中的`6.修改运行参数部分`
集群部署请参照[集群部署(Cluster)](/zh-cn/docs/2.0.0/user_doc/guide/installation/cluster.html)中的`6.修改运行参数部分`
