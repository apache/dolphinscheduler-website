    ...
    sidemenu: [
      {
        ...
        children: [
          {
            title: 'Introduction',
            link: '/en-us/docs/2.0.7/user_doc/About_DolphinScheduler/About_DolphinScheduler.html',
          },
          {
            title: 'Hardware Environment',
            link: '/en-us/docs/2.0.7/user_doc/guide/installation/hardware.html',
          },
          {
            title: 'Glossary',
            link: '/en-us/docs/2.0.7/user_doc/architecture/designplus.html',
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            link: '/en-us/docs/2.0.7/user_doc/guide/installation/standalone.html',
          },
          {
            title: 'Pseudo Cluster Deployment',
            link: '/en-us/docs/2.0.7/user_doc/guide/installation/pseudo-cluster.html',
          },
          {
            title: 'Cluster Deployment',
            link: '/en-us/docs/2.0.7/user_doc/guide/installation/cluster.html',
          },
          {
            title: 'Kubernetes Deployment',
            link: '/en-us/docs/2.0.7/user_doc/guide/installation/kubernetes.html',
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            link: '/en-us/docs/2.0.7/user_doc/guide/homepage.html',
          },
          {
            title: 'Project',
            children: [
              {
                title: 'Project List',
                link: '/en-us/docs/2.0.7/user_doc/guide/project/project-list.html',
              },
              {
                title: 'Workflow Definition',
                link: '/en-us/docs/2.0.7/user_doc/guide/project/workflow-definition.html',
              },
              {
                title: 'Workflow Instance',
                link: '/en-us/docs/2.0.7/user_doc/guide/project/workflow-instance.html',
              },
              {
                title: 'Task Instance',
                link: '/en-us/docs/2.0.7/user_doc/guide/project/task-instance.html',
              },
            ],
          },
          {
            ...
            children: [
              {
                title: 'Shell',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/shell.html',
              },
              {
                title: 'SubProcess',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/sub-process.html',
              },
              {
                title: 'Dependent',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/dependent.html',
              },
              {
                title: 'Stored Procedure',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/stored-procedure.html',
              },
              {
                title: 'SQL',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/sql.html',
              },
              {
                title: 'Spark',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/spark.html',
              },
              {
                title: 'MapReduce',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/map-reduce.html',
              },
              {
                title: 'Python',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/python.html',
              },
              {
                title: 'Flink',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/flink.html',
              },
              {
                title: 'HTTP',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/http.html',
              },
              {
                title: 'DataX',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/datax.html',
              },
              {
                title: 'Pigeon',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/pigeon.html',
              },
              {
                title: 'Conditions',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/conditions.html',
              },
              {
                title: 'Switch',
                link: '/en-us/docs/2.0.7/user_doc/guide/task/switch.html',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                link: '/en-us/docs/2.0.7/user_doc/guide/parameter/built-in.html',
              },
              {
                title: 'Global Parameter',
                link: '/en-us/docs/2.0.7/user_doc/guide/parameter/global.html',
              },
              {
                title: 'Local Parameter',
                link: '/en-us/docs/2.0.7/user_doc/guide/parameter/local.html',
              },
              {
                title: 'Parameter Context',
                link: '/en-us/docs/2.0.7/user_doc/guide/parameter/context.html',
              },
              {
                title: 'Parameter Priority',
                link: '/en-us/docs/2.0.7/user_doc/guide/parameter/priority.html',
              },
            ],
          },
          {
            ...
            children: [
              {
                title: 'Introduction',
                link: '/en-us/docs/2.0.7/user_doc/guide/datasource/introduction.html',
              },
              {
                title: 'MySQL',
                link: '/en-us/docs/2.0.7/user_doc/guide/datasource/mysql.html',
              },
              {
                title: 'PostgreSQL',
                link: '/en-us/docs/2.0.7/user_doc/guide/datasource/postgresql.html',
              },
              {
                title: 'HIVE',
                link: '/en-us/docs/2.0.7/user_doc/guide/datasource/hive.html',
              },
              {
                title: 'Spark',
                link: '/en-us/docs/2.0.7/user_doc/guide/datasource/spark.html',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                link: '/en-us/docs/2.0.7/user_doc/guide/alert/alert_plugin_user_guide.html',
              },
              {
                title: 'Enterprise Wechat',
                link: '/en-us/docs/2.0.7/user_doc/guide/alert/enterprise-wechat.html',
              },
              {
                title: 'Ding Talk',
                link: '/en-us/docs/2.0.7/user_doc/guide/alert/dingtalk.html',
              },
            ],
          },
          {
            title: 'Resource',
            link: '/en-us/docs/2.0.7/user_doc/guide/resource.html',
          },
          {
            title: 'Monitor',
            link: '/en-us/docs/2.0.7/user_doc/guide/monitor.html',
          },
          {
            title: 'Security',
            link: '/en-us/docs/2.0.7/user_doc/guide/security.html',
          },
          {
            title: 'Flink',
            link: '/en-us/docs/2.0.7/user_doc/guide/flink-call.html',
          },
          {
            title: 'Upgrade',
            link: '/en-us/docs/2.0.7/user_doc/guide/upgrade.html',
          },
          {
            title: 'Expansion and Reduction',
            link: '/en-us/docs/2.0.7/user_doc/guide/expansion-reduction.html',
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            link: '/en-us/docs/2.0.7/user_doc/architecture/design.html',
          },
          {
            title: 'Metadata',
            link: '/en-us/docs/2.0.7/user_doc/architecture/metadata.html',
          },
          {
            title: 'Configuration File',
            link: '/en-us/docs/2.0.7/user_doc/architecture/configuration.html',
          },
          {
            title: 'Task Structure',
            link: '/en-us/docs/2.0.7/user_doc/architecture/task-structure.html',
          },
          {
            title: 'Load Balance',
            link: '/en-us/docs/2.0.7/user_doc/architecture/load-balance.html',
          },
          {
            title: 'Cache',
            link: '/en-us/docs/2.0.7/user_doc/architecture/cache.html',
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            link: '/en-us/docs/2.0.7/user_doc/guide/observability/skywalking-agent.html',
          },
        ],
      },
      {
        ...
        children: [
          {
            title: 'Open API',
            link: '/en-us/docs/2.0.7/user_doc/guide/open-api.html',
          },
          {
    ...
    sidemenu: [
      {
        ...
        children: [
          {
            title: '简介',
            link: '/zh-cn/docs/2.0.7/user_doc/About_DolphinScheduler/About_DolphinScheduler.html',
          },
          {
            title: '建议配置',
            link: '/zh-cn/docs/2.0.7/user_doc/guide/installation/hardware.html',
          },
          {
            title: '名称解释',
