...
Please download the source code package apache-dolphinscheduler-2.0.6-src.tar.gz, download address: [download](/en-us/download/download.html)
...
> PowerShell should use `cd apache-dolphinscheduler-2.0.6-src\docker\docker-swarm`
...
Please download the binary distribution package apache-dolphinscheduler-2.0.6-bin.tar.gz, download address: [download](/en-us/download/download.html). And put apache-dolphinscheduler-2.0.6-bin.tar.gz into the `apache-dolphinscheduler-2.0.6-src/docker/build` directory, execute in Terminal or PowerShell:

```
$ cd apache-dolphinscheduler-2.0.6-src/docker/build
$ docker build --build-arg VERSION=2.0.6 -t apache/dolphinscheduler:2.0.6 .
```

> PowerShell should use `cd apache-dolphinscheduler-2.0.6-src/docker/build`
