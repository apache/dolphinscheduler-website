...
Please download the source code package apache-dolphinscheduler-1.3.7-src.tar.gz, download address: [download](/en-us/download/download.html)
...
```
$ tar -zxvf apache-dolphinscheduler-1.3.7-src.tar.gz
...
> PowerShell should use `cd apache-dolphinscheduler-1.3.7-src\docker\docker-swarm`
...
Please refer to the `Quick Start` in the chapter [User Manual](/en-us/docs/1.3.7/user_doc/quick-start.html) to explore how to use DolphinScheduler
...
Please download the binary distribution package apache-dolphinscheduler-1.3.7-bin.tar.gz, download address: [download](/en-us/download/download.html). And put apache-dolphinscheduler-1.3.7-bin.tar.gz into the `apache-dolphinscheduler-1.3.7-src/docker/build` directory, execute in Terminal or PowerShell:

```
$ cd apache-dolphinscheduler-1.3.7-src/docker/build
$ docker build --build-arg VERSION=1.3.7 -t apache/dolphinscheduler:1.3.7 .
```

> PowerShell should use `cd apache-dolphinscheduler-1.3.7-src/docker/build`
...
```
FROM apache/dolphinscheduler:1.3.7
