...
- [Download](https://dolphinscheduler.apache.org/en-us/docs/release/download.html) the latest version of the installation packages.
...
- Standalone Deployment please refer the [6, Modify running arguments] in [Standalone-Deployment](https://dolphinscheduler.apache.org/en-us/docs/1.3.3/user_doc/standalone-deployment.html).
- Cluster Deployment please refer the [6, Modify running arguments] in [Cluster-Deployment](https://dolphinscheduler.apache.org/en-us/docs/1.3.3/user_doc/cluster-deployment.html).
