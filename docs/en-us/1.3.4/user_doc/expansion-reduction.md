...
cd /opt
# decompress
tar -zxvf apache-dolphinscheduler-incubating-1.3.4-dolphinscheduler-bin.tar.gz -C /opt 
cd /opt
mv apache-dolphinscheduler-incubating-1.3.4-dolphinscheduler-bin  dolphinscheduler
```
...
```
- If the expansion is for worker nodes, you need to set the worker group. Please refer to the user manual [5.7 Worker grouping](/en-us/docs/1.3.4/user_doc/system-manual.html)
