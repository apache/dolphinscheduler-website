...
The configuration file is `values.yaml`, and the [DolphinScheduler Kubernetes Configuration](https://github.com/apache/dolphinscheduler/blob/1.3.6/docker/kubernetes/dolphinscheduler/README.md#configuration) lists the configurable parameters of the DolphinScheduler chart and their default values.
