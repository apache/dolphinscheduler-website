...
Please download the source code package apache-dolphinscheduler-1.3.6-src.tar.gz, download address: [download](https://dolphinscheduler.apache.org/en-us/download/download.html)
...
Please download the binary distribution package apache-dolphinscheduler-1.3.6-bin.tar.gz, download address: [download](https://dolphinscheduler.apache.org/en-us/download/download.html). And put apache-dolphinscheduler-1.3.6-bin.tar.gz into the `apache-dolphinscheduler-1.3.6-src/docker/build` directory, execute in Terminal or PowerShell:
