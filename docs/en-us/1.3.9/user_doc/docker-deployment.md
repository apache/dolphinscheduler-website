...
Please download the source code package apache-dolphinscheduler-1.3.9-src.tar.gz, download address: [download](https://dolphinscheduler.apache.org/en-us/download/download.html)
...
> PowerShell should use `cd apache-dolphinscheduler-1.3.9-src\docker\docker-swarm`
...
Please refer to the `Quick Start` in the chapter [User Manual](https://dolphinscheduler.apache.org/en-us/docs/1.3.9/user_doc/quick-start.html) to explore how to use DolphinScheduler
...
Please download the binary distribution package apache-dolphinscheduler-1.3.9-bin.tar.gz, download address: [download](https://dolphinscheduler.apache.org/en-us/download/download.html). And put apache-dolphinscheduler-1.3.9-bin.tar.gz into the `apache-dolphinscheduler-1.3.9-src/docker/build` directory, execute in Terminal or PowerShell:
...
> PowerShell should use `cd apache-dolphinscheduler-1.3.9-src/docker/build`
