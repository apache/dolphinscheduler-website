...
Please download the binary distribution package apache-dolphinscheduler-1.3.9-bin.tar.gz, download address: [download](/en-us/download/download.html). And put apache-dolphinscheduler-1.3.9-bin.tar.gz into the `apache-dolphinscheduler-1.3.9-src/docker/build` directory, execute in Terminal or PowerShell:
