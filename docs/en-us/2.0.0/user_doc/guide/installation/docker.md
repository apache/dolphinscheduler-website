...
> PowerShell should use `cd apache-dolphinscheduler-2.0.0-src\docker\docker-swarm`
...
Please download the binary distribution package apache-dolphinscheduler-2.0.0-bin.tar.gz, download address: [download](/en-us/download/download.html). And put apache-dolphinscheduler-2.0.0-bin.tar.gz into the `apache-dolphinscheduler-2.0.0-src/docker/build` directory, execute in Terminal or PowerShell:
