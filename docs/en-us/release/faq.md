...
A: 1, Create deployment user and hosts mapping, please refer 1.3 part of [cluster deployment](https://dolphinscheduler.apache.org/en-us/docs/1.3.4/user_doc/cluster-deployment.html)

​		2, Configure hosts mapping and ssh access and modify directory permissions. please refer 1.4 part of [cluster deployment](https://dolphinscheduler.apache.org/en-us/docs/1.3.4/user_doc/cluster-deployment.html)
...
```   
 ...
 ``` 
   3, if the 2nd step failure, please, [referer url](https://dolphinscheduler.apache.org/zh-cn/docs/1.3.4/user_doc/frontend-development.html)
```
