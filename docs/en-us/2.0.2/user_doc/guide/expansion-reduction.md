...
```
- If the expansion is for worker nodes, you need to set the worker group. Please refer to the security [Worker grouping](docs/en-us/2.0.2/user_doc/guide/security.md)
